...
////////////////////////////////////////////////////////////////////////
	...
	auto opticalphoton = [&fixed_z, &particleDefinition, &particleEnergy](auto event){generate_particles_in_event(event, random_generator_tpb(), generate_partilces_and_energies_tuples(particleDefinition, particleEnergy));};   	
